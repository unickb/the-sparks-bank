...
<div id="container">
    ...
    <div class="container-large"
        style="color:#8B0000; height:500px; width: 100%; padding:8% 2% 2% 2%; background-color:white;">
        <div class="row">
            <div class="col" style="margin-left: 5%;">
                <br><br>&nbsp;<p class="zoomfont"
                    style="font-size:0px; text-shadow:3px 3px 3px grey; text-align:center;"><b>The <br> Sparks
                        Bank!</b></p>
            </div>
            <div class="col" style="margin:4% 0% 0% 5%; text-align:center;">
                &nbsp;<img src="bank-1.jpg" class="zoomin" alt="" style="width:0px;">
            </div>
        </div>
    </div>
    ...
    <center style="margin:60px 0px 20px 0px;">
        <div class="container"
            style="backdrop-filter: blur(10px);background-color:#808080; box-shadow:3px 3px 15px black; border-radius:30px; padding:20px 0px 20px 0px;">
            <h1 style="text-shadow:2px 2px 2px gray; color:white;"><b>QUICK SERVICES</b></h1>
            <div class="container" style="margin:30px 0px 20px 0px;">
                <div class="row">
                    <div class="col-lg">
                        <div
                            style="background-color:#8B0000; color:white; width: 90%; border-radius:30px; box-shadow:3px 3px 8px gray; padding:20px 10px 20px 10px;">
                            <i class="fas fa-users fa-7x"></i><br><br>
                            <a href="all_cust.php"><button type="button" class="btn btn-outline-success mybtn">View
                                    Customers</button></a><br>
                            <h6>List of our customers.</h6>
                        </div>
                    </div>
                    <div class="col-lg">
                        <div
                            ...
                            <a href="send_money.php"><button type="button" class="btn btn-outline-success mybtn">Transfer
                                    Money</button></a><br>
                    ...
                    <div class="col-lg">
                        <div
                            ...
                            <a href="check_blc.php"><button type="button" class="btn btn-outline-success mybtn">Check
                                    Balance</button></a><br>
                            <h6>Check the current balance.</h6>
                        </div>
                    </div>
                </div>
            </div>
...
<footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
    <div class="col-md-4 d-flex align-items-center">
      ...
      <span class="mb-3 mb-md-0 text-muted">© 2022 The Sparks Bank, All rights reserved</span>
    </div>
    <p class=" d-flex justify-content-center align-items-center">Website develped with ❤️ by Navneet &ensp;
